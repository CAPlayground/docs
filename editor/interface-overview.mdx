...
- **Gyro Controls** (gyro wallpapers only): Bottom-left panel to simulate device tilt

<Info>
  The canvas shows your wallpaper at your device's actual resolution. What you see is what you get!
</Info>

**Gyro Controls Panel (Gyro Wallpapers Only):**

When working on a gyro wallpaper, a control panel appears in the bottom-left corner:
- **Grid/Phone toggle**: Switch between grid view and phone visualization
- **Grid view**: Drag the knob to simulate device tilt
- **Phone view**: Drag the 3D phone to see realistic tilt effects
- **Recenter button**: Reset tilt to neutral position (crosshair icon)

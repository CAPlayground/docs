...
<Info>
  Editing Covered Layers: Since the FLOATING layer in a gyro wallpaper covers the BACKGROUND layer, you might find it difficult to select and edit background elements on the canvas. To work around this, you can temporarily hide the FLOATING layer by clicking the eye icon next to it in the Layers Panel. This will allow you to easily access and edit the BACKGROUND layer.
</Info>
...
- **For position**: Values in pixels. The min max values set the range the layer can move when you tilt your phone. (e.g., -50 to 50 means tilting your phone to the very left will make the layer go to the position-50, and tilting your phone to the very right will make the layer go to the position 50.)
- **For rotation**: Values in radians. The min max values set the range the layer can rotate when you tilt your phone. (e.g., -0.5 to 0.5 for subtle rotation)
